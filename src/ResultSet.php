...
class ResultSet implements \Iterator, IRowContainer
{
     ...
     * @param string|int|null $key column name used for an array key or null for numeric index
     * @param string|int|null $value column name used for an array value or null for the whole row
     * @return array
     */
